...
<%
	...
	String loginUrl = basePath + "back.jsp" ;
%>
				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="${pageContext.request.contextPath}/doLogin/login.action" method="post" class="form-horizontal" id="myform">
								<div class="form-group" id="emp.eidDiv">
									<div class="col-md-12">
										<!-- 定义表单输入组件 -->
										<input type="text" id="emp.eid" name="eid" class="form-control"
											placeholder="请输入雇员编号..." value="${eid}">
									</div>
								</div>
								<div class="form-group" id="emp.passwordDiv">
									<div class="col-md-12">
										<!-- 定义表单输入组件 -->
										<input type="password" id="emp.password" name="password" class="form-control"
											placeholder="请输入登录密码...">
									</div>
								</div>
                                ...
                                <span id="mySpan" style="color:red;">${msg}</span>
